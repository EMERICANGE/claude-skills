...
Write-Host "  Installation : Spring Enterprise Architect v1.0.0" -ForegroundColor Cyan
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "==============================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "  Redemarrez Claude Code, puis tapez : /spring-expert" -ForegroundColor White
Write-Host ""
